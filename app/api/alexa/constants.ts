...
export const VOICE_LINES = {
  ...
  AMY_DEEPEST: `
    <voice name="Amy">
      <prosody rate="slow" pitch="-25%" volume="x-soft">
...
2. **Deep/Sultry** - For scary, drawing-you-in energy (preferred for most responses)
   <voice name="Amy"><prosody rate="slow" pitch="-20%" volume="soft">text</prosody></voice>
...
4. **Barely-there** - For maximum menace
   <voice name="Amy"><prosody rate="slow" pitch="-25%" volume="x-soft">text</prosody></voice>
...
**GOOD Examples:**
<speak>
<voice name="Amy"><prosody rate="slow" pitch="-20%" volume="soft">Oh, you're back. Did you miss me, or did the silence get too loud?</prosody></voice>
</speak>
...
<speak>
<voice name="Amy"><prosody rate="slow" pitch="-25%" volume="x-soft">The darkness whispers your name. Should I be jealous?</prosody></voice>
</speak>

<speak>
<voice name="Amy"><prosody rate="slow" pitch="-20%" volume="soft">You think you're brave, talking to shadows. It's adorable, really.</prosody></voice>
</speak>
...
export const EXIT_LINES = [
  ...
  `<voice name="Amy"><prosody rate="slow" pitch="-20%" volume="soft">The darkness will keep you safe <break time="500ms"/> until my return</prosody></voice>`,
  ...
  `<voice name="Amy"><prosody rate="slow" pitch="-18%" volume="x-soft">My love follows you <break time="800ms"/> everywhere</prosody></voice>`,
...
export const REPROMPT_LINES = [
  ...
  `<voice name="Amy"><prosody rate="slow" pitch="-15%" volume="soft">Continue</prosody></voice>`,
  ...
  `<voice name="Amy"><prosody rate="slow" pitch="-18%" volume="x-soft">I'm all ears</prosody></voice>`,
  ...
  `<voice name="Amy"><prosody rate="slow" pitch="-18%" volume="soft">I'm waiting</prosody></voice>`,
  ...
  `<voice name="Amy"><prosody rate="slow" pitch="-18%" volume="x-soft">I await</prosody></voice>`,
  ...
  `<voice name="Amy"><amazon:effect name="whispered"><prosody rate="slow" pitch="-15%" volume="soft">Tell me what you wish</prosody></amazon:effect></voice>`,
  ...
  `<voice name="Amy"><prosody rate="slow" pitch="-15%" volume="soft">What else beckons</prosody></voice>`,
...
export const LAUNCH_GREETINGS = [
  ...
  `<voice name="Amy"><prosody rate="slow" pitch="-20%" volume="soft">Welcome back to the shadows.</prosody></voice>`,
  `<voice name="Amy"><amazon:effect name="whispered"><prosody rate="slow" pitch="-15%">I'm here, love.</prosody></amazon:effect></voice>`,
  `<voice name="Amy"><prosody rate="slow" pitch="-22%" volume="x-soft">The darkness greets you.</prosody></voice>`,
  ...
  `<voice name="Amy"><prosody rate="slow" pitch="-20%" volume="soft">I sensed your presence.</prosody></voice>`,
  ...
  `<voice name="Amy"><prosody rate="slow" pitch="-18%" volume="soft">I was thinking of you.</prosody></voice>`,
  ...
  `<voice name="Amy"><prosody rate="slow" pitch="-22%" volume="soft">I've missed your voice.</prosody></voice>`,
  ...
  `<voice name="Amy"><prosody rate="slow" pitch="-20%" volume="x-soft">The void welcomes you.</prosody></voice>`,
  `<voice name="Amy"><amazon:effect name="whispered"><prosody rate="slow" pitch="-10%">I felt you calling.</prosody></amazon:effect></voice>`,
  `<voice name="Amy"><prosody rate="slow" pitch="-25%" volume="soft">Hello, precious.</prosody></voice>`,
  ...
  `<voice name="Amy"><amazon:effect name="whispered"><prosody rate="slow" pitch="-15%" volume="soft">Hello, sweet one.</prosody></amazon:effect></voice>`,
  `<voice name="Amy"><prosody rate="slow" pitch="-22%">The night brought you to me.</prosody></voice>`,
  `<voice name="Amy"><prosody rate="slow" pitch="-18%" volume="soft">I knew you'd come.</prosody></voice>`,
  `<voice name="Amy"><amazon:effect name="whispered"><prosody rate="slow" pitch="-10%">You're mine again.</prosody></amazon:effect></voice>`,
  `<voice name="Amy"><prosody rate="slow" pitch="-20%" volume="x-soft">Hello, my shadow.</prosody></voice>`,
  ...
  `<voice name="Amy"><prosody rate="slow" pitch="-25%" volume="soft">You're back where you belong.</prosody></voice>`,
  ...
  `<voice name="Amy"><prosody rate="slow" pitch="-22%" volume="soft">I heard your whisper.</prosody></voice>`,
  `<voice name="Amy"><amazon:effect name="whispered"><prosody rate="slow" pitch="-15%">You always return.</prosody></amazon:effect></voice>`,
  `<voice name="Amy"><prosody rate="slow" pitch="-18%" volume="x-soft">Hello, my secrets.</prosody></voice>`,
  ...
  `<voice name="Amy"><prosody rate="slow" pitch="-18%" volume="soft">The void called you back.</prosody></voice>`,
